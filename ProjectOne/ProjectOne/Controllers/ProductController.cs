...
namespace ProjectOne.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ProductController(ProjectOneContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Name,Price,Id")] ProductViewModel productViewModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Price,Id")] ProductViewModel productViewModel)
        {
